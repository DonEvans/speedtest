...
//Output
	document.write(" Your computer took " + elapsedTime + " milliseconds to find all " + (list.length + 2) + " primes less than " + PRIMES_LESS_THAN + ".<br>");
...
function primeFinder(decade) {
	...
	//Generate candidates, don't bother with even numbers or anything ending in 5.
